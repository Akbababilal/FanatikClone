...
async function renderComments(newsId) {
    console.log('renderComments called for newsId:', newsId);
    ...
    similarNewsItems.forEach(item => {
        item.addEventListener('click', () => {
            ...
            if (selectedSimilarNews) {
                // Seçilen benzer haberi görüntüleme işlemini gerçekleştirin.
...
// This function sets up event listeners for the "View Comments" buttons
// This function sets up event listeners for the "View Comments" buttons
function setupViewCommentsButtonListeners() {
    // Retrieve all the "View Comments" buttons
